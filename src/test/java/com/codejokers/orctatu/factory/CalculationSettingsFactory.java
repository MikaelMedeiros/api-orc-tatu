...
public class CalculationSettingsFactory {
    ...
    private static final String CALCULATION_SETTINGS_JSON = "{\"id\":\"1\",\"pricePerCentimeter\":20,\"studioPercentage\":20,\"parkingCost\":10000,\"materialCost\":190,\"creditCardFee\":20}";
